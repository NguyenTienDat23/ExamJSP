...
@WebServlet("/students")
    public class StudentServlet extends HttpServlet {
        ...
        public void init() throws ServletException {
            ...
            studentList.add(new Student(1, "Quoc Anh ", "a", 10));
            studentList.add(new Student(2, "Quoc Anh 1", "b", 9.5));
            studentList.add(new Student(3, "Quoc Anh 2", "c", 8.0));
            studentList.add(new Student(4, "Quoc Anh 3", "d", 10));
        }
